...
var sequel = `${title} 2: The Chamber of Secrets`;
console.log(sequel);
...
var books = ["Harry Potter 1", "Harry Potter 2", "Harry Potter 3", "Harry Potter 4", "Harry Potter 5"];
console.log(books);
...
var belowTwoHundred = [199, 198, 197, 196, 195, 194, 193, 192, 191, 190, 189, 188];
